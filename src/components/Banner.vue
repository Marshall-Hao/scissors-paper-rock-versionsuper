<template>
    <div class="p-5 mt-10 border-2 border-white justify-self-center rounded-xl w-full md:w-3/6 border-opacity-90 flex justify-between">
        <img src="../assets/images/logo-bonus.svg" alt="logo" class="h-20 md:h-auto">
        <div class="bg-white py-3 px-6 md:px-12 rounded-xl text-center">
